...
b) Does the missingness in any field correlate to the response variable or to other fields' values? This may help determine how to deal with the missing values.

**By looking at bivariate, or "two-way" tables, we can assess the relationship between whether a "Sex" observation is missing and each of the categorical fields in the dataset. Comparing mean values in a continuous field, split over whether the "Sex" value is missing, shows us whether there is some correlation there. **
